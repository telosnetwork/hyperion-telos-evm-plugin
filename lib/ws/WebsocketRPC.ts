...
import LogSubscription from "./LogSubscription.js";
...
export default class WebsocketRPC {
    ...
    websocketClient: ReconnectingWebSocket.default
    ...
    initWSClient() {
        this.websocketClient = new ReconnectingWebSocket.default(this.config.indexerWebsocketUri, [], {WebSocket});
