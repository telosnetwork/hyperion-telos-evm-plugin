import {HyperionPlugin} from "../../../src/interfaces/hyperion-plugin.js";
...
import {HyperionDelta} from "../../../src/interfaces/hyperion-delta.js";
import Bloom from "./bloom/index.js";
import {hLog} from "../../../src/helpers/common_functions.js";
import {blockHexToHash, toChecksumAddress} from "./utils.js"
import RPCBroadcaster from "./ws/RPCBroadcaster.js";
import WebsocketRPC from "./ws/WebsocketRPC.js";
...
export default class TelosEvm extends HyperionPlugin {
    ...
    constructor(config: TelosEvmConfig) {
        ...
        if (this.baseConfig) {
            ...
            if (config.chainId) {
                this.common = ethCommon.default.forCustomChain(
                    this.baseChain,
    ...
    addRoutes(server: FastifyInstance): void {
        ...
        server.register(autoLoad.default, {
